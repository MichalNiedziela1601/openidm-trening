...
VALUES
("bfelming",sha1("password1"),"Bob", "Fleming","Bob Fleming","Bob.Fleming@example.com","HR",CURRENT_TIMESTAMP),
("scarter",sha1("password"),"Sam","Carter","Sam Carter","scarter@example.com","HR",CURRENT_TIMESTAMP),
("rbirkin",sha1("password2"),"Rowley","Birkin","Rowley Birkin","Rowley.Birkin@example.com","SALES",CURRENT_TIMESTAMP),
("lbalfour",sha1("password3"),"Louis", "Balfour","Louis Balfour","Louis.Balfor@example.com","SALES",CURRENT_TIMESTAMP),
("jsmith",sha1("password4"),"John", "Smith","John Smith","John.Smith@example.com","SUPPORT",CURRENT_TIMESTAMP),
...
sql.execute("grant all on hrdb.* to root@'%' IDENTIFIED BY 'example';")
